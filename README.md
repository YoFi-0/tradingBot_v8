...
* 🟢 **Backtesting Engine:** **Fully Functional & Highly Accurate**  
  *The backtesting pipeline delivers outstanding performance, providing reliable historical market simulations and strategy verification.*
...
1. **Clone the repository:**
   ```bash
   git clone [https://github.com/YoFi-0/tradingBot_v8.git](https://github.com/YoFi-0/tradingBot_v8.git)
   cd tradingBot_v8
